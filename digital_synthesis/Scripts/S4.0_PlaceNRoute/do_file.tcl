...
read_netlist [getenv DesignPath]/PSynthesis/${DesignName}.v
...
## Load Floorplan
##############################################################################
read_def   [getenv DesignPath]/PSynthesis/${DesignName}.def
...
set_db write_stream_text_size          0.2
...
file copy   -force ${_OUTPUTS_PATH}/${DesignName}_SYN.v [getenv HDLPath]/${DesignName}_SYN.v

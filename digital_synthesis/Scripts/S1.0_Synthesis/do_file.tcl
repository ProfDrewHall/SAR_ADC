...
##############################################################################
write_design -innovus -base_name [getenv _OUTPUTS_PATH]/Synthesis/${DesignName}
file delete -force [getenv DesignPath]/Synthesis
file copy   -force [getenv _OUTPUTS_PATH]/Synthesis [getenv DesignPath]/Synthesis
